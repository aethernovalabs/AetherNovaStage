...
export const TestStageRunner = <StageType extends StageBase<InitStateType, ChatStateType, MessageStateType, ConfigType>,
    ...
    async function runTests() {
        await stage.setState({location: "Solmeryn Kingdom - The Lamplighter's Nest - Hidden Chamber", timeOfDay: "Midday", clock: "13:12", you: "Unknown - Human (Regular clothing; Standing; hands visible)", npc: "None", thread: "None", wallet: "0G ; 0S ; 0C", walletInitialized: false, npcMemory: {}, privateEvents: [], pendingNpcDebugQuery: null, pendingNpcMemoryCommand: null, userStatus: { gender: "Unknown", apparentRace: "Human", clothing: {}, weapons: [], importantItems: [] }});
        refresh();
        ...
        const afterPromptResponse = await stage.afterResponse({
            ...
            promptForId: null,
            anonymizedId: "2",
            content: `**Solmeryn Kingdom - The Lamplighter's Nest - Hidden Chamber | Midday | 13:12**
