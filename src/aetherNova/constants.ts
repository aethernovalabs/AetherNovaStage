...
export const BODY_RACIAL_DETAIL_PATTERN = /\b(eye|eyes|gaze|tail|tails|ear|ears|wing|wings|horn|horns|halo|fang|fangs|claw|claws|scale|scales|hand|hands|palm|palms|finger|fingers|arm|arms|elbow|elbows|head|face|cheek|cheeks|forehead|chin|mouth|nose|hair|shoulder|shoulders|back|body|torso|waist|hip|hips|knee|knees|leg|legs|thigh|thighs|chest|breast|breasts|nipple|nipples|tongue|lip|lips|penis|cock|vagina|ass|belly|stomach|foot|feet|toe|toes|posture|voice|weapon|sword|blade|staff)\b/i;
